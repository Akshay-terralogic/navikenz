<?php
	...
	function tax_opportunity_department() {

		$labels = array(
			'name'                       => _x( 'Opportunities', 'Taxonomy General Name', 'text_domain' ),
			'singular_name'              => _x( 'Opportunity', 'Taxonomy Singular Name', 'text_domain' ),
		...
		register_taxonomy( 'opportunity-department', array( 'opportunities' ), $args );

	}
	add_action( 'init', 'tax_opportunity_department', 0 );
	...
	function ctp_whitepaper() {
		$labels = array(
			...
			'view_item'             => __( 'View Whitepaper', 'text_domain' ),
			'view_items'            => __( 'View Whitepapers', 'text_domain' ),
			'search_items'          => __( 'Search Whitepaper', 'text_domain' ),
			'not_found'             => __( 'Not found', 'text_domain' ),
			'not_found_in_trash'    => __( 'Not found in Trash', 'text_domain' ),
			'featured_image'        => __( 'Featured Image', 'text_domain' ),
			'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
			'remove_featured_image' => __( 'Remove featured image', 'text_domain' ),
			'use_featured_image'    => __( 'Use as featured image', 'text_domain' ),
			'insert_into_item'      => __( 'Insert into Whitepaper', 'text_domain' ),
			'uploaded_to_this_item' => __( 'Uploaded to this Whitepaper', 'text_domain' ),
			'items_list'            => __( 'Whitepapers list', 'text_domain' ),
			'items_list_navigation' => __( 'Whitepapers list navigation', 'text_domain' ),
			'filter_items_list'     => __( 'Filter Whitepapers list', 'text_domain' ),
		);
		$args = array(
			'label'                 => __( 'Whitepaper', 'text_domain' ),
			'description'           => __( 'Whitepaper Description', 'text_domain' ),
			'labels'                => $labels,
			'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions' ),
			'taxonomies'            => array( '' ),
			'hierarchical'          => false,
	...
	add_action( 'init', 'ctp_whitepaper', 0 );