...
<main>
  ...
  <section class="kn-banner error-404"> 
    <div class="container"> 
      <div class="row"> 
        <div class="col-md-6"> <img class="kn-banner__img img-fit" src="<?php echo $tempDir ?>/img/404/404.png" alt=""></div>
        <div class="col-md-6 d-flex align-items-center"> 
          <div class="kn-banner__wrp"><img src="<?php echo $tempDir ?>/img/404/404.svg" alt="">
