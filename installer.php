...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20220405_navikenz_671b3ba058ee9ac47671_20220405051904_archive.zip';
    const ARCHIVE_SIZE       = '1044375229';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '671b3ba-05051904';
    const SECONDARY_PACKAGE_HASH = 'c3e1e47-05051904';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.3.1==');
        $this->log('----------------------------------------------------');
