...
<section class="kn-details back-btn">
  ...
  <div class="container"> 
    <div class="kn-details__container">
      <div class="row"> 
        <div class="col-xl-10"> 
          <div class="sub-text"><span class="sub-text"><?php echo get_the_date(); ?> </span><span class="sub-text"> | </span><span class="sub-text">Case Study </span><span class="sub-text"> | </span><span class="sub-text"><?php  echo reading_time(); ?></span></div>
          <h1 class="Nk-h1 clr-w fnt-700"><?php echo get_the_title(); ?></h1>
        </div>
        <div class="col-xl-2 d-flex align-items-md-end"> 
          <div class="logo-wrp"> <a href="https://twitter.com/navikenzai"> <img src="<?php echo $tempDir; ?>/img/icons/white/twitter.svg" alt=""></a><a href="https://www.linkedin.com/company/navikenz"> <img src="<?php echo $tempDir; ?>/img/icons/white/linkedin.svg" alt=""></a></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="right-container"> 
    <div class="row"> 
      ...
      <div class="col-lg-5">
        ...
        <?php $terms = get_the_terms( $post->ID, 'case-tag-cloud' );
        if (is_array($terms)) : ?>
          <ul class="tags-wrap">
